...
*            tty_sites TYPE TABLE OF ehfnd_location_uuid_ref.
  ...
  "Filtres
  DATA: lt_sites      TYPE RANGE OF ernam,
        lt_from_date  TYPE RANGE OF ernam,
        lt_to_date    TYPE RANGE OF ernam,
...
*    id =  |{ id ALPHA = IN }|.
  ...
  " Fetch all direct children of the parent
  ...
  "Monthly kpis
  CASE lv_kpiname.
    WHEN 'acc_trav' OR 'maladie-pro' OR 'acc_trajet' OR 'taux_clot' OR 'taux_pre' OR 'nbr_pres' OR 'taux_met'.
